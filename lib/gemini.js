import { readAsStringAsync } from 'expo-file-system/legacy'; // Updated to use the legacy API
...
// Updated to use the direct, raw string instead of the broken object
export async function imageToBase64(uri) {
  const base64 = await readAsStringAsync(uri, {
    encoding: 'base64', // CHANGED THIS LINE
  });
  return base64;
}
